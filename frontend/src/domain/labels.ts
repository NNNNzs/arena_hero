...
export const REASON_LABELS: Record<string, string> = {
  ...
  path_to_resource: '前往资源路径', preserve_worker_cargo: '保留工人货物', core_capacity_full_vacate: '核心满仓腾退', core_capacity_full_wait: '核心满仓等待', cargo_doorstep_wait_for_entry: '满仓门口等待入库', current_resource: '当前资源', stale: '决策已过期',
