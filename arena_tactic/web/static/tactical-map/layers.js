...
(() => {
  ...
  TacticalMap.COLORS = Object.freeze({ bg: '#071016', observed: '#10232C', grid: '#31515E', friendly: '#58C9BE', resource: '#D9AA55', enemy: '#E56B73', text: '#D6E2E4', muted: '#829BA6', obstacle: '#263B45' });
  TacticalMap.COLOR_NUMBERS = Object.freeze({ bg: 0x071016, observed: 0x10232c, grid: 0x31515e, friendly: 0x58c9be, resource: 0xd9aa55, enemy: 0xe56b73, text: 0xd6e2e4, obstacle: 0x263b45 });
