...
_WAIT_REASONS = {
    ...
    "intercept_pursuit_grace_blocked": ("BLOCKED", "ROUTE_AVAILABLE", None),
    ...
    "defensive_firing_route_blocked": ("BLOCKED", "ROUTE_AVAILABLE", None),
    "doorstep_last_stand_hold": ("ACTIVE", "NEXT_AUTHORITATIVE_TURN", 1),
    ...
    "cargo_doorstep_wait_for_entry": ("RESOURCE_WAIT", "CORE_CAPACITY_AVAILABLE", 1),
